        ...
        {shops.map((shop) => (
          <CarouselItem key={shop.id} className="basis-1/3">
            {shop.screenshotPath ? (
              ...
              <div className="h-full overflow-hidden rounded-2xl border-[0.5px] border-clay-border bg-surface-raised shadow-[0_16px_40px_-18px_rgba(43,10,16,0.22)]">
                <img
              ...
              <div className="h-full rounded-2xl border-[0.5px] border-clay-border bg-surface-raised p-5 text-left shadow-[0_16px_40px_-18px_rgba(43,10,16,0.22)]">
