...
// Pure presentational row of shop cards — the caller (SampleShopsPage) owns fetching, the section
// heading and the empty state. Real shops (merchants.is_sample), NON-clickable — no <Link>/<a
// href> anywhere in this file. That is deliberate: the landing page used to link straight into a
// live storefront (`/s/bitetime-co`) and customers placed real orders on it (fcd0a57). This
// carousel replaces that link entirely rather than reintroducing it across more shops. See
