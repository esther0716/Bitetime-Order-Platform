  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "peer relative flex size-4 shrink-0 items-center justify-center rounded-xs border-[0.5px] border-clay-border bg-white transition-colors outline-none cursor-pointer",
